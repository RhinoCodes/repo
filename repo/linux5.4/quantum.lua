...
function install()
    ...
    os.execute("mkdir " .. install_dir .. "/boot")
    ...
    os.execute("ln -s " .. install_dir .. "/boot/{vmlinuz-5.4.77,System.map-5.4.77,config-5.4.77} " .. root .. "/boot/")
    os.execute("ln -s " .. install_dir .. "/lib/modules/5.4.77 " .. root .. "/usr/lib/modules/5.4.77")
end 

function uninstall()
	os.execute("rm -rf " .. install_dir .. " " .. root .. "/boot/{vmlinuz-5.4.77,System.map-5.4.77,config-5.4.77}")
end
